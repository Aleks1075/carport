...
@WebServlet(name = "=updatematerialprice", value = "/updatematerialprice")
public class UpdateMaterialPrice extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        MaterialFacade.updateMaterialPrice(material_id, price, connectionPool);
